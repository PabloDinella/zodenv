...
[![trunk](https://github.com/pablodinella/pablodinella/zodenv/actions/workflows/trunk.yaml/badge.svg)](https://github.com/pablodinella/pablodinella/zodenv/actions/workflows/trunk.yaml)
...
1. Run:
   ...
   ```
   corepack enable && \
   gh repo clone pablodinella/pablodinella/zodenv <directory> && \
   cd <directory> && \
   pnpm install && \
